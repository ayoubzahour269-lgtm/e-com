...
const ESSENCE_MORPH_MOTION =
  "In elegant slow motion the whole bottle smoothly UNWINDS and reshapes: its solid form gradually loses the bottle silhouette and flows outward, the entire product turning into a single THICK S-shaped ribbon of DEEP TRANSLUCENT GARNET-RED hair oil — the exact dark ruby-red of the oil inside the bottle — glossy, wet and photorealistic like flowing red liquid silk (NOT amber, NOT orange, NOT gold, NOT caramel, NOT metallic, NOT honey-colored), with only subtle warm rim highlights, curving through the frame and swirling among floating green henna leaves and red hibiscus petals in soft warm light, until the whole bottle has become one continuous flowing deep-red oil ribbon. Realistic real-liquid physics, one seamless continuous morph, no pouring, no splashing, mass conserved. Photorealistic. No text.";
